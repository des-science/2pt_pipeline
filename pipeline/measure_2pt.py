...
class Measure2Point(PipelineStage):
    ...
    def __init__(self, param_file):
        ...
        self.gold_selector = load_catalog(self.params, 'gold', 'mcal', self.params['gold_group'], self.params['gold_table'], self.params['gold_path'], self.Dict, inherit=self.source_selector)
        self.pz_selector   = load_catalog(self.params, 'pz', 'mcal', self.params['pz_group'], self.params['pz_table'], self.params['pz_path'], self.Dict,   inherit=self.source_selector)
    ...
    def setup_jobs(self,pool):
        ...
        all_calcs = [(i,j) for i in range(nbin) for j in range(nbin)]
