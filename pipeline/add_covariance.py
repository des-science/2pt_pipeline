...
twopoint_filename = "/global/homes/a/aamon/DES/Y1/bestfitY1_Y1cov_LS.fits" #sys.argv[1]
covmat_filename = "/global/homes/a/aamon/DES/Y1/covLS.dat" #sys.argv[2]
new_filename = "/global/homes/a/aamon/DES/Y1/Y1_withcov_LS.fits" #sys.argv[3]
...
print("Now you need to make sure that the ordering of the covariance matrix matches the ordering in the text file!")
print("Expecting this order: #Name Bin1 Bin2 Angle")
n = 0
