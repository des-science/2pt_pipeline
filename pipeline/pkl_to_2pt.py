...
ss_bin_to_index = {'0_0':list(range(20)),
                   '0_1':list(range(20,40)),
                   '0_2':list(range(40,60)),
                   '0_3':list(range(60,80)),
                   '1_1':list(range(80,100)),
                   '1_2':list(range(100,120)),
                   '1_3':list(range(120,140)),
                   '2_2':list(range(140,160)),
                   '2_3':list(range(160,180)),
                   '3_3':list(range(180,200))}
pp_bin_to_index = {'0_0':list(range(20)),
                   '1_1':list(range(20,40)),
                   '2_2':list(range(40,60)),
                   '3_3':list(range(60,80)),
                   '4_4':list(range(80,100))}
sp_bin_to_index = {'0_0':list(range(20)),
                   '0_1':list(range(20,40)),
                   '0_2':list(range(40,60)),
                   '0_3':list(range(60,80)),
                   '1_0':list(range(80,100)),
                   '1_1':list(range(100,120)),
                   '1_2':list(range(120,140)),
                   '1_3':list(range(140,160)),
                   '2_0':list(range(160,180)),
                   '2_1':list(range(180,200)),
                   '2_2':list(range(200,220)),
                   '2_3':list(range(220,240)),
                   '3_0':list(range(240,260)),
                   '3_1':list(range(260,280)),
                   '3_2':list(range(280,300)),
                   '3_3':list(range(300,320)),
                   '4_0':list(range(320,340)),
                   '4_1':list(range(340,360)),
                   '4_2':list(range(360,380)),
                   '4_3':list(range(380,400))}
...
if 'shear_shear_pixellized.pkl' in all_pkl:
    ...
    for i in list(ss_bin_to_index.keys()):
...
if 'shear_pos_pixellized.pkl' in all_pkl:
    ...
    for i in list(sp_bin_to_index.keys()):
...
if 'pos_pos_pixellized.pkl' in all_pkl:
    ...
    for i in list(pp_bin_to_index.keys()):
