...
class Measure2Point(PipelineStage):
    ...
    def get_hpix(self,pix=None):
        if pix == None:
            print self.gold_selector.get_col(self.Dict.gold_dict['hpix'])[0],self.params['hpix_nside'] ,self.get_nside() , self.gold_selector.get_col(self.Dict.gold_dict['hpix'])[0] // ( hp.nside2npix(self.params['hpix_nside']) // hp.nside2npix(self.get_nside()) ), hp.nside2npix(self.params['hpix_nside']) // hp.nside2npix(self.get_nside())
