...
class Measure2Point(PipelineStage):
    ...
    def calc_shear_shear(self,i,j,ipix,verbose,num_threads):
        ...
        for x in range(9):
            ...
            self.write_h5(f,path,'meanlogr',gg.meanlogr)
            self.write_h5(f,path,'xip',gg.xip)
            self.write_h5(f,path,'xim',gg.xim)
            self.write_h5(f,path,'npairs',gg.npairs)
            self.write_h5(f,path,'weight',gg.weight)
    ...
    def calc_pos_shear(self,i,j,ipix,verbose,num_threads):
        ...
        for x in range(9):
            ...
            self.write_h5(f,path,'meanlogr',ng.meanlogr)
            self.write_h5(f,path,'ngxi',ng.xi)
            self.write_h5(f,path,'ngxim',ng.xi_im)
            self.write_h5(f,path,'rgxi',rg.xi)
            self.write_h5(f,path,'rgxim',rg.xi_im)
            self.write_h5(f,path,'ngnpairs',ng.npairs)
    ...
    def calc_pos_pos(self,i,j,ipix,verbose,num_threads):
        ...
        for x in range(9):
            ...
            self.write_h5(f,path,'nrnpairs',nr.npairs)
            self.write_h5(f,path,'nrweight',nr.weight)
            self.write_h5(f,path,'rnnpairs',rn.npairs)
            self.write_h5(f,path,'rnweight',rn.weight)
            self.write_h5(f,path,'rrnpairs',rr.npairs)
            self.write_h5(f,path,'rrweight',rr.weight)
            self.write_h5(f,path,'nntot',nn.tot)
            self.write_h5(f,path,'nrtot',nr.tot)
            self.write_h5(f,path,'rntot',rn.tot)
            self.write_h5(f,path,'rrtot',rr.tot)
        f.close()
